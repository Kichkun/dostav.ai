...
int main(): 
    ...
    def create_data_model(matrix, dist, n_couriers, time_windows, payments):
    ...
    def create_reward_matrix(pickup_id):
        return [data[1][pickup_id[i] - 30000]['payment'] for i in range(len(pickup_id))]
    payments = create_reward_matrix(pickup_id)
    ...
    def main():
        ...
        # [START data]
        data = create_data_model(matrix, dist, n_couriers, time_windows, payments)
        # [END data]
